...
export class GetFeedPosts implements UseCase<GetFeedPostsInput, GetFeedPostsOutput> {
  constructor(private readonly postRepository: PostRepository) {}

  async execute({ categoryId, mode = 'latest' }: GetFeedPostsInput): Promise<GetFeedPostsOutput> {
