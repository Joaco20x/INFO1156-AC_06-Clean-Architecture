...
export const getCommentsByPostId = new GetCommentsByPostId(
    commentRepository,
    postRepository,
)
...
export const getAllProhibitedWords = new GetAllProhibitedWords(
    prohibitedWordRepository,
)
export const addProhibitedWord = new AddProhibitedWord(prohibitedWordRepository)
export const deleteProhibitedWord = new DeleteProhibitedWord(
    prohibitedWordRepository,
)
